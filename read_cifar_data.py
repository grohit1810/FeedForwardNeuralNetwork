...
for file in train_files :
	...
	for i in xrange(0,len(data['labels'])):
		if data['labels'][i] == 3:
			cat_train_samples.append(convert_rgb_to_grayscale_and_normalize(data['data'][i].tolist()))
		if data['labels'][i] == 4:
			deer_train_samples.append(convert_rgb_to_grayscale_and_normalize(data['data'][i].tolist()))
...
for i in xrange(0,len(test_data['labels'])):
	if test_data['labels'][i] == 3:
		cat_test_samples.append(convert_rgb_to_grayscale_and_normalize(test_data['data'][i].tolist()))
	if test_data['labels'][i] == 4:
		deer_test_samples.append(convert_rgb_to_grayscale_and_normalize(test_data['data'][i].tolist()))
